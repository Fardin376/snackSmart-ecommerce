...
/**
 * Get products sorted by user preferences
 */
const getProductsByPreference = async (userId, sessionId) => {
  try {
    const params = {
      sortBy: 'preferences',
    };
    ...
    console.error('getProductsByPreference error:', error);
    throw error.response?.data || error;
  }
};
